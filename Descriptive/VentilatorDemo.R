...
train <- train[which(train$COVID_Status== 1), ]

#Demographic characteristics - Train only 

demographics <- summary( Ventilator ~ DRIVERS + PASSPORT + MARITAL + RACE + ETHNICITY + 
...
allergy <- summary(Ventilator ~ Allergy.to.bee.venom + Allergy.to.dairy.product + 
...
careplans <- summary(Ventilator ~ Agreeing.on.diabetes.care.plan +                                                                                 
...
conditions <- summary(Ventilator ~ Acute.Cholecystitis_x +                                                                                           
...
devices <- summary(Death ~ Coronary.artery.stent..physical.object. +                                                                         
...
encounters <- summary(Death ~ Admission.to.surgical.department +                                                                                  
...
encounters_reason <- summary(Death ~ Acute.Cholecystitis_y  +                                                                                          
...
imaging <- summary(Ventilator ~ Ankle  +                                                                                                          
 Arm            +                                                                                                  
 Chest         +                                                                                                   
 Clavicle    +                                                                                                     
 Knee          +                                                                                                   
...
vaccines <- summary(Ventilator ~ DTaP                                                                                                             
         +  HPV..quadrivalent                                                                                                
         + Hep.A..adult                                                                                                     
...
medications <- summary(Ventilator ~ X0.25.ML.Leuprolide.Acetate.30.MG.ML.Prefilled.Syringe   +                                                        
...
observations <- summary(Ventilator ~  Systolic.Blood.Pressure+                                                                                          
...
procedures <- summary(Ventilator ~  Admission.to.burn.unit +                                                                                         
...
observations_reason <- summary(Ventilator ~   Acute.bronchitis..disorder._y_1  +                                                                                  
